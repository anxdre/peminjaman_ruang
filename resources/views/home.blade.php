            ...
            <div class="card-body">
              <div class="summary">
                <div class="summary-info">
                  <h4>Rp {{$total_all_fasilitas_harga}}</h4>
                  <div class="text-muted">Terpinjam {{$total_all_fasilitas}} items dari {{$jumlah_transaksi}} transaksi</div>
                  <div class="d-block mt-2">
                    <a href="/master/fasilitas">View All</a>
                  </div>
                </div>
                <div class="summary-item">
                  <h6>Item List <span class="text-muted">({{count($ft)}} Items)</span></h6>
                  <ul class="list-unstyled list-unstyled-border">
                    @foreach($ft as $kry => $ftvalue)
                    <li class="media">
                      <div class="media-body">
                        <div class="media-right">Rp {{$sum_fasilitas_harga[$ftvalue->id_fasilitas]}}</div>
                        <div class="media-title"><a href="#">{{$ftvalue->fasilitas->nama}}</a></div>
